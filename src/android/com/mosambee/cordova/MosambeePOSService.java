    ...
    public class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void goForPrint(){
            ...
            if (b && myPrinter != null && myPrinter.getCurrentStatus() == 0) {
                //printData();
                Bitmap icon = BitmapFactory.decodeResource(cordova.getActivity().getResources(), R.drawable.screen);
                Drawable myDrawable = cordova.getActivity().getResources().getDrawable(R.drawable.screen);
